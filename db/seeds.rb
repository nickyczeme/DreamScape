...
corona_virus = Dream.create(title: "Corona Virus", description: "I remember having the symptoms but insisting I'm fine and trying to go about my day, only to end up getting tested and have it confirmed I have covid.", intensity: 1, price: 10, user: sol, mode: nightmares, address: "Wienerstraße 5, 2120 Wolkersdorf im Weinviertel, Austria")
...
the_crucible = Dream.create(title: "The Crucible", description: "The Crucible of Steel is a game of wits. Of luck. Of Chance. Opponents face each other, one-on-one. A sword in the middle of the arena, a dagger at their side. The rules are simple, but the game is hard. Only a lone champion can emerge. Only one can survive.", intensity: 2, price: 4, user: mojito, mode: nightmares, address: 'calle espartinas 7, madrid')
...
burning_chrome = Dream.create(title: "Burning Chrome", description: "the story of how they burned Chrome, a sophisticated security system with ties to organized crime.", intensity: 2, price: 7, user: nicky, mode: fantasy, address: "Plaza Mayor 44")
...
#wellness
coming_back = Dream.create(title: "Coming Back", description: "my girlfriend had come back to me after breaking up with me. I was extremely happy and content until I woke up and it hadn't really happened.", intensity: 4, price: 9, user: mojito, mode: wellness, address: 'Madrid')
...
puppy = Dream.create(title: "Puppy", description: "My family went to the mall to look at puppies. I was happy because we were going to get a puppy and everyone was the age we are now.", intensity: 5, price: 4.5, user: fanny, mode: wellness, address: '28013 Madrid')
...
beach_day = Dream.create(title: "Beach Day", description: "I had a dream I was at the beach with my family. We were playing football in the sand and everyone was so happy. It was a good time. At the end we went out to eat.", intensity: 4, price: 7.5, user: sol, mode: wellness, address: 'Plaza de España, 28008 Madrid')
...
meeting_your_dog_again = Dream.create(title: "Meeting Your Dog Again", description: "I had a dream about my dog who had passed away 2 years ago. We were at the park and she was running and playing like we use too when she was still with me. I was happy during the dream.", intensity: 3, price: 8, user: sol, mode: wellness, address: 'C. de Embajadores, 41, 28012 Madrid')
...
conviencing_him_to_stay_over = Dream.create(title: "Convincing Him To Stay Over", description: "I had a dream that I convinced my flirt to stay over. We were in marylebone somewhere nice. He took a bit of convincing. I love him I was happy. I can't really remember the conversation I woke up happy though.", intensity: 3, price: 4.5, user: mojito, mode: romantic, address: 'calle de orfila 7, madrid')
