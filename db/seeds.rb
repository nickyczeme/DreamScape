...
sol = User.create(email: "sbuker@itba.edu.ar", first_name: "Sol", last_name: "Büker", password: "123456")
mojito = User.create(email: "mojito@hotmail.com", first_name: "Mojito", last_name: "Hund", password: "123456")

# ....
#nightmares
falling = Dream.create(title: "Falling", description: "There's a rush of air on your face as you plunge over the edge into nothingness. You flail about, frantic for something to grab before you hit bottom, but there’s nothing — and no one — to save you. Terror consumes you as the bottom comes into view, and then, slam! You wake up in bed. Your heart is beating too fast, but you’re safe. It was just a dream.", intensity: 2, price: 7.50, user: barbie, mode: nightmares, address: "Calle de San Bernardo 13, Madrid")
...
feeling_trapped = Dream.create(title: "Feeling Trapped", description: "I was walking home from a fun night out and suddently my feet where stuck to the floor and I could not move anymore.", intensity: 2, price: 5.00, user: nicky, mode: nightmares, address: "Calle de San Bernardo 13, Madrid")
...
beeing_attacked = Dream.create(title: "Beeing Attacked", description: "The man was already staring for me for hours, I noticed that more and more people keft the subway and suddenly I was all alone with the man", intensity: 3, price: 5.50, user: fanny, mode: nightmares, address: "Calle de Bernardo 13, Madrid")
...
waking_up_late = Dream.create(title: "Waking Up Late", description: "Tommorow is the big day, I will stand infront all of my colleagues and show them how great I am. Everything was working out until.. ", intensity: 1, price: 4.00, user: barbie, mode: nightmares, address: "Paseo Castellana 56, 28046 Madrid Spanien")
...
corona_virus = Dream.create(title: "Corona Virus", description: "I remember having the symptoms but insisting I'm fine and trying to go about my day, only to end up getting tested and have it confirmed I have covid.", intensity: 1, price: 10.00, user: sol, mode: nightmares, address: "Wienerstraße 5, 2120 Wolkersdorf im Weinviertel, Austria")
...
drowning = Dream.create(title: "Drowning", description: "I was at a hotel with my ex boyfriend Rory and our dogs. It was dark out and I was out by the pool with the dogs when one of the dogs, Trevor, started drowning in the pool. I screamed for help and jumped in to save him but Rory was “on an important work call” and did not come to help. I was devastated, terrified, and angry.", intensity: 3, price: 9.00, user: barbie, mode: nightmares, address: "Calle Julio Camba, C. Julio Camba, 28028 Madrid")
...
the_crucible = Dream.create(title: "The Crucible", description: "The Crucible of Steel is a game of wits. Of luck. Of Chance. Opponents face each other, one-on-one. A sword in the middle of the arena, a dagger at their side. The rules are simple, but the game is hard. Only a lone champion can emerge. Only one can survive.", intensity: 2, price: 4.00, user: mojito, mode: nightmares, address: 'calle espartinas 7, madrid')
...
the_city_born_great = Dream.create(title: "The City Born Great", description: "New York. In this inventive tale, New York City has grown old enough that it is time for it to be 'born' — but only if one reluctant midwife can keep its ancient enemies at bay.", intensity: 3, price: 7.00, user: barbie, mode: fantasy, address: "Calle de San Bernardo 13, Madrid")
...
help_me_follow = Dream.create(title: "Help Me Follow", description: "", intensity: 3, price: 7.00, user: barbie, mode: fantasy, address: "Pascual Yunquera 60")
...
the_time_machine = Dream.create(title: "The Time Machine", description: "He ends up in the world of AD 802,701, in a London that has been transformed into a vast garden, and where humankind has evolved into two distinct subspecies: the above-ground Eloi and the sinister subterranean Morlocks …", intensity: 4, price: 5.00, user: barbie, mode: fantasy, address: "Valadouro 77")
...
#wellness
coming_back = Dream.create(title: "Coming Back", description: "my girlfriend had come back to me after breaking up with me. I was extremely happy and content until I woke up and it hadn't really happened.", intensity: 4, price: 9.00, user: mojito, mode: wellness, address: 'Madrid')
...
puppy = Dream.create(title: "Puppy", description: "My family went to the mall to look at puppies. I was happy because we were going to get a puppy and everyone was the age we are now.", intensity: 5, price: 4.50, user: fanny, mode: wellness, address: '28013 Madrid')
...
beach_day = Dream.create(title: "Beach Day", description: "I had a dream I was at the beach with my family. We were playing football in the sand and everyone was so happy. It was a good time. At the end we went out to eat.", intensity: 4, price: 7.50, user: sol, mode: wellness, address: 'Plaza de España, 28008 Madrid')
...
receiving_flowers = Dream.create(title: "Receiving Flowers", description: "I dreamt that my husband surprised me with a plant. It had one exotic red flower that rose up on a long stem. I was very pleased that he had thought of me and my love of flowers.", intensity: 2, price: 3.50, user: mojito, mode: wellness, address: 'C. del Caballero de Gracia 28013 Madrid')
...
meeting_your_dog_again = Dream.create(title: "Meeting Your Dog Again", description: "I had a dream about my dog who had passed away 2 years ago. We were at the park and she was running and playing like we use too when she was still with me. I was happy during the dream.", intensity: 3, price: 8.00, user: sol, mode: wellness, address: 'C. de Embajadores, 41, 28012 Madrid')
...
#romantic
first_date = Dream.create(title: "First Date", description: "First date, he got me champagne, and he treated me like a Princess. He was speaking thru the whole date, but I have no idea what he said. It was lovely just to hear him speaking. My heart was so happy!", intensity: 1, price: 1.50, user: barbie, mode: romantic, address: 'paseo de la castellana 57, madrid')
...
conviencing_him_to_stay_over = Dream.create(title: "Convincing Him To Stay Over", description: "I had a dream that I convinced my flirt to stay over. We were in marylebone somewhere nice. He took a bit of convincing. I love him I was happy. I can't really remember the conversation I woke up happy though.", intensity: 3, price: 4.50, user: mojito, mode: romantic, address: 'calle de orfila 7, madrid')
